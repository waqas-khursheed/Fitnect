...
$(function(e) {
	...
	AmCharts.ready(function() {
		...
		distanceGraph.lineColor = "#6e00ff ";
		...
		latitudeGraph.lineColor = "#ff6e00";
		...
		latitudeGraph.bulletBorderColor = "#ff6e00";
		latitudeGraph.bulletBorderAlpha = 1;
		latitudeGraph.bulletBorderThickness = 2;
		latitudeGraph.bulletColor = "#ff6e00";
